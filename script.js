...
function click_function(){
	if(inputlength()>0 && input.value !== item[0].item_name && input.value !== item[1].code && input.value !== item[2].enter && input.value !== item[3].code && input.value !== item[4].code){
...
function keypress_function(event){
	if(inputlength()>0 && event.which === 13 && input.value !== item[0].item_name && input.value !== item[1].code && input.value !== item[2].enter && input.value !== item[3].code && input.value !== item[4].code){
	var li = document.createElement("li");
	li.setAttribute("class", "li_part");
	li.appendChild(document.createTextNode(input.value));
	ol.appendChild(li);
	...
	if(input.value === item[4].code && event.which === 13){
		zoom1.style.display = "block";
		input.value = "";
	}
}
