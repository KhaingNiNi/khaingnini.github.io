...
function click_function(){
	...
	if(input.value === pressD){
		part1.className = "animated fadeOut";
		part2.className = "animated fadeOut delay-1s";
		part3.className = "animated fadeOut delay-2s";
		part41.className = "animated fadeOut delay-3s";
		part410.className = "animated fadeOut delay-3s";
		part411.className = "animated fadeOut delay-3s";
		part412.className = "animated fadeOut delay-3s";
		part413.className = "animated fadeOut delay-3s";
		part42.className = "animated fadeOut delay-3s";
		part43.className = "animated fadeOut delay-3s";
		part44.className = "animated fadeOut delay-3s";
		part45.className = "animated fadeOut delay-3s";
		part46.className = "animated fadeOut delay-3s";
		part47.className = "animated fadeOut delay-3s";
		part48.className = "animated fadeOut delay-3s";
		part49.className = "animated fadeOut delay-3s";
		part5.className = "animated fadeOut delay-4s";
	}
}
